...
from arguments import (DataTrainingArguments, ModelArguments,
                       MyTrainingArguments)
from data_sft import build_instruction_dataset, DataCollatorForSupervisedDataset
...
def main():
    ...
    if model_args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(model_args.tokenizer_name, **tokenizer_kwargs, torch_dtype=torch.bfloat16)
    elif model_args.tokenizer_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained(model_args.tokenizer_name_or_path, **tokenizer_kwargs, torch_dtype=torch.bfloat16)
    else:
        raise ValueError(
