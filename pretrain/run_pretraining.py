...
from data import TrainDataset, fault_tolerance_data_collator
from peft import (
    LoraConfig,
    PeftModel,
    TaskType,
...
def main():
    ...
    if model_args.config_name:
        ...
        config = AutoConfig.from_pretrained(pretrained_model_name_or_path=model_args.model_name_or_path, **config_kwargs)
    else:
    ...
    lm_datasets = TrainDataset(data_args, tokenizer).build_dataset()
